...
There are different implementations of Core War. We choose to allow 16 operations. The first 16 hexadecimals store operations, **a coding byte**. The numbers 17 - 255 are regular digits. 
